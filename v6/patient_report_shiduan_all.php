...
$daochu_user_arr = array("zhuwenya", "卓志华", "刘蓓");
...
$hospital_id_name = $db->query("select id, name from hospital where ishide=0 and sname='$hospital_name' and name not like '%新媒体%' order by id asc", "id", "name");
...
<div class="center_show">
	...
	<div class="report_tips"><?php echo $hospital_name." (".count($hospital_id_name)."个科室)"; ?>　时段统计报表</div>
...
<center>注：不包含自然到诊数据和新媒体科室数据</center>
<br>
<br>

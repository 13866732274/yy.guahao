...
if ($debug_mode || in_array($uinfo["part_id"], array(9))) {
	$types = $db->query("select id,concat(name,' (',wangluo_zuzhang,'*',zixun_zhuguan,')') as name from count_type where ishide=0 and type='web' order by name asc", "id", "name");
} else {
	$hids = implode(",", $hospital_ids);
	$types = $db->query("select id,concat(name,' (',wangluo_zuzhang,'*',zixun_zhuguan,')') as name from count_type where ishide=0 and type='web' and hid in ($hids) order by name asc", "id", "name");
}
if (count($types) == 0) {
	exit("没有可以管理的项目");
}
...
.main_title {margin:0 auto; padding-top:20px; padding-bottom:15px; text-align:center; font-size:18px !important; font-family:"微软雅黑"; }

.list {border:2px solid #b8bbbe !important; margin:0 auto; }
.item {padding:8px 3px 8px 3px !important; }
.list td {border-color:#b8bbbe !important; }

.hl {border-left:1px solid #b8bbbe !important; }
.hr {border-right:1px solid #b8bbbe !important; }
.ht {border-top:1px solid #b8bbbe !important; }
.hb {border-bottom:1px solid #b8bbbe !important; }
...
<div style="margin:10px 0 0 0px;" class="noprint" >
	...
	<button onclick="print(); return false;" class="button">打印</button>
</div>
...
<table width="100%" align="center" class="list">
	<tr>
		<td class="head hr hb" align="center">客服 (1-10号)</td>
		<td width="10%" class="head hl hb no_b" align="center">总到诊</td>
		<td width="10%" class="head hb no_b" align="center">商务通到诊</td>
		<td width="10%" class="head hb no_b" align="center">咨询预约率</td>
		<td width="10%" class="head hb no_b" align="center">预约就诊率</td>
		<td width="10%" class="head hb no_b" align="center">咨询就诊率</td>
		<td width="10%" class="head hb no_b" align="center">流失人数</td>
		<td width="20%" class="head hb no_b" align="center">备注</td>
	</tr>
...
<table width="100%" align="center" class="list">
	<tr>
		<td class="head hr hb" align="center">客服 (11-20号)</td>
		<td width="10%" class="head hl hb no_b" align="center">总到诊</td>
		<td width="10%" class="head hb no_b" align="center">商务通到诊</td>
		<td width="10%" class="head hb no_b" align="center">咨询预约率</td>
		<td width="10%" class="head hb no_b" align="center">预约就诊率</td>
...
<table width="100%" align="center" class="list">
	<tr>
		<td class="head hr hb" align="center">客服 (21-30号)</td>
		<td width="10%" class="head hl hb no_b" align="center">总到诊</td>
		<td width="10%" class="head hb no_b" align="center">商务通到诊</td>
		<td width="10%" class="head hb no_b" align="center">咨询预约率</td>
		<td width="10%" class="head hb no_b" align="center">预约就诊率</td>

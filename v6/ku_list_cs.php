...
$sql = "select * from $table $sqlwhere $sqlsort limit $offset,$pagesize";
print_r($sql);
// 查询:
...
.hf_line {border:0; height:1px; line-height:0; font-size:0; margin:6px 20px 6px 0px; padding:0; }

.tr_yuyue, .tr_yuyue * {color:green !important; }
.tr_come, .tr_come * {color:red !important; }
.tr_abort, .tr_abort * {color:#a0a0a0 !important; }
.tr_wx, .tr_wx * {color:#408080 !important; }

.tips {background:none; font-family:"微软雅黑"; font-size:14px; border:0; }
</style>
...
function tongyuansou(hid, key) {
	var url = "patient_tongyuansou.php?code=utf8&hid="+hid+"&key="+encodeURIComponent(key)+"&r="+Math.random();
...
<?php } ?>
		...
		<td class="headers_oprate" style="width:300px">
			...
			<form name="topform" method="GET" style="display:inline;">
				...
				<a href="javascript:;" onclick="more_search(); return false;" class="ml">高级搜索</a><font color="red">[新]</font>
...
<style type="text/css">
.high_search {border:1px solid silver; padding:8px; }
</style>
<div class="high_search">当前为高级搜索模式　搜索条件为　<font color="red"><?php echo $high_search_show; ?></font><?php echo $high_search_result; ?>　　<?php if ($debug_mode) { ?><font color="blue"><?php echo $high_search_code; ?></font><?php } ?></div>
<div class="space"></div>
<?php } ?>
...
?>
		<th class="head" align="<?php echo $tdalign; ?>" width="<?php echo $tdwidth; ?>"><nobr><?php echo $tdtitle; ?></nobr></th>
<?php } ?>
	</tr>
	<!-- 表头定义 end -->
...
?>
	<tr onmouseover="mi(this)" onmouseout="mo(this)" class="<?php echo $class; ?>">
		<td align="left" class="item"><a href="?hospital=<?php echo $line["hid"]; ?>" title="点击查看同医院患者"><nobr><?php echo $line["h_name"]; ?></nobr></a><br><nobr><?php echo $part_name; ?></nobr></td>
		<td align="left" class="item"><nobr><?php echo $track_status; ?></nobr></td>
		<td align="left" class="item"><nobr><?php echo $genzong_cishu; ?>次</nobr></td>
		<td align="left" class="item"><nobr><?php echo $name_string; ?></nobr></td>
		<td align="left" class="item"><nobr><?php echo $line["qq"]; ?></nobr></td>
		<td align="left" class="item"><nobr><?php echo $line["weixin"]; ?></nobr></td>
		<!-- <td align="left" class="item"><?php echo cut($line["disease_name"], 16, "…"); ?></td> -->
		<td align="left" class="item"><?php echo $content; ?></td>
		<td align="left" class="item"><nobr><?php echo $line["laiyuan"]; ?></nobr></td>
		<td align="left" class="item"><nobr><?php echo wee_time($line["addtime"]); ?></nobr></td>
		<!-- 20200630二次开发提醒日期 -->
		<td align="left" class="item"><nobr><?php echo $remind_date; ?></nobr></td>
		<td align="left" class="item"><nobr><?php echo str_replace("【HE】", "", $line["u_name"]); ?></nobr></td>
		<td align="center" class="item"><nobr><?php echo $line["to_weixin"] ? "是" : "--"; ?></nobr></td>
		<td align="left" class="item"><nobr><?php echo str_replace("【HE】", "", $line["wx_uname"]); ?></nobr></td>
		<td align="left" class="item"><nobr id="wxhy_<?php echo $id; ?>"><?php echo $haoyou_status; ?></nobr></td>
...
<div class="footer_op">
	<div class="footer_op_left">
		共 <b><?php echo $count; ?></b> 条资料　　<a href="?is_yuyue=1"><font class="tr_yuyue">[已约]</font></a>　<a href="?is_come=1"><font class="tr_come">[已到]</font></a>　<?php if ($is_daochu) { ?><a href="javascript:;" onclick="parent.load_src(1, 'ku_daochu.php');">[导出]</a><?php } ?>　执行时间：<?php echo round(now() - $pagebegintime, 4); ?>秒
	</div>

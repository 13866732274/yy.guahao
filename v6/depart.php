...
$aTdFormat = array(
	...
	1 => array("title" => "ID", "width" => "60", "align" => "center", "sort" => "id", "defaultorder" => 1),
	2 => array("title" => "科室名称", "width" => "", "align" => "left", "sort" => "binary name", "defaultorder" => 1),
...
<head>
    ...
    function add() {
        set_high_light('');
        parent.load_src(1, 'depart_edit.php', 700, 350);
        return false;
    }

    function edit(id, obj) {
        set_high_light(obj);
        parent.load_src(1, 'depart_edit.php?id=' + id, 700, 350);
        return false;
    }
    </script>
</head>
...
<body>
    ...
    <table class="headers" width="100%">
        <tr>
            <td class="headers_title" style="width:280px;">
                <nobr class="tips"><?php echo $hospital_id_name[$user_hospital_id]; ?> - 科室列表</nobr>
            </td>
            ...
            <td class="headers_oprate" style="width:280px;">
    ...
    <form name="mainform">
        <table width="100%" align="center" class="list">
            ...
            <tr<?php echo $hide_line ? " class='hide'" : ""; ?>>
                <td align="center" class="item"><input name="delcheck" type="checkbox" value="<?php echo $id; ?>"
    ...
    <!-- 分页链接 begin -->
    <div class="footer_op">
        <div class="footer_op_left"><button onclick="select_all()" class="button">全选</button>&nbsp;<button
                onclick="unselect()"
                class="button">反选</button>&nbsp;<?php echo show_button("hd", $pinfo, $pagepower); ?></div>
